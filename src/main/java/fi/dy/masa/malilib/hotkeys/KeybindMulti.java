...
//        if (this.keyCodes.size() == 1) pressedLast = false;// this is fix for single key but i dont know why
...
//                            keyCodeObj, allowExtraKeys, allowOutOfOrder, this.keyCodes.contains(keyCodeObj), this.keyCodes, PRESSED_KEYS, triggeredCount);
                    this.pressed = false;
                    break;
                }
            }
...
//            }
    ...
    public boolean isModified() {
        return this.getStringValue().equals(this.defaultStorageString) == false || this.areSettingsModified();
    }
...
//                    }
        ...
        if (ManyLibConfig.Debug.KEYBIND_DEBUG.getBooleanValue()) {
...
//        }
        ...
        if (ManyLibConfig.Debug.KEYBIND_DEBUG_ACTIONBAR.getBooleanValue()) {
