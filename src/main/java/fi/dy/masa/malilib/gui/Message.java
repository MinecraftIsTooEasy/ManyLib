...
//    public int renderAt(int x, int y, int textColor, DrawContext drawContext) {
    ...
    public enum MessageType {
        INFO("manyLib.message.formatting_code.info"),
        SUCCESS("manyLib.message.formatting_code.success"),
        WARNING("manyLib.message.formatting_code.warning"),
        ERROR("manyLib.message.formatting_code.error");
