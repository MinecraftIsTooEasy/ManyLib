...
public class LegacyDefaultConfigScreen extends LegacyListScreen<ConfigItem<?>> implements Searchable {
    ...
    public void initGui() {
        ...
        if (this.firstSeen) {
            ...
            this.setPage(ProgressSaving.getStatus(this.configInstance.getName()));
        }
        this.onPageChange();
    ...
    public void onGuiClosed() {
        ...
        ProgressSaving.saveProgress(this.configInstance.getName(), this.currentTabIndex, this.getPage());
        this.firstSeen = true;
    }
